        ...
        <div class="row gy-5 justify-content-center">
          <div class="col-12 col-lg-5">
            <form method="post">
              <div class="row gy-3 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control border-0 border-bottom border-warning rounded-0" name="email" id="email" placeholder="name@example.com" required>
                ...
                <div class="col-12 mb-2">
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control border-0 border-bottom border-warning rounded-0" name="password" id="password" value="" placeholder="Password" required>
              ...
              <div class="col-12">
                <p class="text-center m-0">Don't have an account? <a class="text-warning" href="signup">Register</a></p>
              </div>
            </form>
          </div>
    </div>
